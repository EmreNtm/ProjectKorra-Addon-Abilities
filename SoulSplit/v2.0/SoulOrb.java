  ...
  implements AddonAbility, ComboAbility
{
  ...
  public void displayOrb(Location location)
  {
    ...
    {
      this.progressExplosion = false;
      ParticleEffect.ENCHANTMENT_TABLE.display(location, 1, 3.0D, 1.0D, 3.0D, 0.0D);
      ParticleEffect.END_ROD.display(location, 2, 0.0D, 0.0D, 0.0D, 0.0D);
      ParticleEffect.CRIT_MAGIC.display(location, 3, 0.20000000298023224D, 0.20000000298023224D, 0.20000000298023224D, 0.0D);
    }
    if (System.currentTimeMillis() > this.time + this.duration)
    {
      this.playDormant = false;
      ParticleEffect.FIREWORKS_SPARK.display(location, 10, 0.0D, 0.0D, 0.0D, 0.05000000074505806D);
      remove();
      return;
    }
  ...
  public void explodeOrb()
  {
    ...
    {
	  ParticleEffect.FIREWORKS_SPARK.display(this.targetLoc, 50, 0.20000000298023224D, 0.20000000298023224D, 0.20000000298023224D, 0.5D);
      ParticleEffect.END_ROD.display(this.targetLoc, 30, 2.0D, 3.0D, 2.0D, 0.0D);
