    ...
    if (new Random().nextInt(this.effectInt) == 0) {
      if ((entity instanceof Player))
      {
        ...
        else
        {
          ...
          ParticleEffect.PORTAL.display(entity.getLocation().add(0.0D, 1.0D, 0.0D), 0.0F, 0.0F, 0.0F, 1.5F, 5);
        }
      }
      else if ((entity instanceof Monster))
      {
        ...
        ParticleEffect.ANGRY_VILLAGER.display(entity.getLocation().add(0.0D, 1.0D, 0.0D), 0.0F, 0.0F, 0.0F, 0.0F, 1);
      }
