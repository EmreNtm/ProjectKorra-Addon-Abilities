  ...
  implements AddonAbility, ComboAbility
{
  ...
  public void spawnCircle()
  {
    ...
    for (int i = 0; i < 6; i++)
    {
      ...
      ParticleEffect.END_ROD.display(this.location2, 0.0F, 0.0F, 0.0F, 0.0F, 1);
      this.location2.subtract(x, 0.0D, z);
      
      this.location3.add(x2, 0.0D, z2);
      ParticleEffect.END_ROD.display(this.location3, 0.0F, 0.0F, 0.0F, 0.0F, 1);
    ...
    if (new Random().nextInt(this.effectInt) == 0) {
      if ((entity instanceof Player))
      {
        ...
        if (bEntity.hasElement(Element.getElement("LightSpirit")))
        {
          ...
          ParticleEffect.HEART.display(ePlayer.getLocation().add(0.0D, 2.0D, 0.0D), 0.0F, 0.0F, 0.0F, 0.0F, 1);
        }
      ...
      else
      {
        ...
        ParticleEffect.HEART.display(entity.getLocation().add(0.0D, 2.0D, 0.0D), 0.0F, 0.0F, 0.0F, 0.0F, 1);
      }
    }
  }
