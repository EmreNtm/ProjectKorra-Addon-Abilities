  ...
  implements AddonAbility, ComboAbility
{
  ...
  public SoulShackle(Player player, Soul soul)
  {
    ...
    player.getWorld().playSound(player.getLocation(), Sound.ENTITY_ENDEREYE_DEATH, 1.0F, -1.0F);
    start();
  }
  ...
  public void bind()
  {
    ...
    else
    {
      ...
      {
        ParticleEffect.CLOUD.display(this.targetLoc, 0.0F, 0.0F, 0.0F, 0.08F, 5);
  ...
  public void blastSpiral(int points, float size, Location location)
  {
    for (int i = 0; i < 6; i++)
    {
      ...
      ParticleEffect.WITCH_MAGIC.display(location, 0.0F, 0.0F, 0.0F, 0.0F, 1);
