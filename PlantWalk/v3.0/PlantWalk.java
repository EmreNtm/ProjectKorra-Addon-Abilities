...
public class PlantWalk extends PlantAbility implements AddonAbility, ComboAbility {
	...
	public void setField() {
		...
		firstFlySpeed = player.getFlySpeed();
		player.sendMessage(firstFlySpeed + "");
		flySpeed = (float) ConfigManager.getConfig().getDouble("ExtraAbilities.Hiro3.Water.PlantWalk.FlySpeed");
	...
	public void remove() {
		...
		player.setFlySpeed(this.firstFlySpeed);
	}
