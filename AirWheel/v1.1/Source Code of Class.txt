package me.Hiro.MyAbilities.AirWheel;
...
public class AirWheel extends AirAbility implements AddonAbility, ComboAbility {
	...
	public void setFields() {
		cooldown = ConfigManager.getConfig().getLong("ExtraAbilities.Hiro3.Air.AirWheel.Cooldown");
		duration = ConfigManager.getConfig().getLong("ExtraAbilities.Hiro3.Air.AirWheel.Duration");
		scooterspeed = ConfigManager.getConfig().getDouble("Abilities.Air.AirScooter.Speed");
		pushFactor = ConfigManager.getConfig().getDouble("ExtraAbilities.Hiro3.Air.AirWheel.PushFactor");
		damageEnabled = ConfigManager.getConfig().getBoolean("ExtraAbilities.Hiro3.Air.AirWheel.DamageEnable");
		damage = ConfigManager.getConfig().getInt("ExtraAbilities.Hiro3.Air.AirWheel.Damage");
	...
	public void spinWheel() {
		...
		for (i = 0; i < 36; i++) {
			...
			getAirbendingParticles().display(location, (float) 0.15, 0, (float) 0.15, 0, 1);
			hit(location);
			hitBurst(location);
			n++;
		}
	...
	public String getInstructions() {
		return "AirBlast (LEFT CLICK) > AirScooter (LEFT CLICK) > AirSuction (Sprint, jump and LEFT CLICK)";
	}
	...
	public void remove() {
		super.remove();
		ProjectKorra.flightHandler.removeInstance(player, this.getName());
		this.bPlayer.addCooldown(this);
	}
	...
	public void load() {
		...
		ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Air.AirWheel.Cooldown", 5000);
		ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Air.AirWheel.Duration", 15000);
		ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Air.AirWheel.maxHeightFromGround", 7);
		ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Air.AirWheel.PushFactor", 0.25);
		ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Air.AirWheel.DamageEnable", true);
		ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Air.AirWheel.Damage", 1);
